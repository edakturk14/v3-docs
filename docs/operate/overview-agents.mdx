...
Every Hyperlane message requires two transactions to be delivered,on the origin chain to [send](../../reference/messaging/send.mdx) the message, and on the destination chain to [receive](../../reference/messaging/receive.mdx) the message
